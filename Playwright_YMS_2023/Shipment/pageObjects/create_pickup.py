...
class CreatePickupPage:
    ...
    def newpickup(self, pickupdetails):
        self.click_shipment()
        self.select_pickup()
        self.create_pickup()
        self.click_pickup()
        self.enter_shipment(pickupdetails['Shipment#'])
        self.choose_site()
        self.select_site()
        ...
        self.enter_ref1(pickupdetails['Ref1'])
        self.enter_ref2(pickupdetails['Ref2'])
        self.enter_trailer(pickupdetails['Trailer'])
        self.enter_lp(pickupdetails['LP'])
        self.next_page1()
        self.next_page2()
        self.save_pickup()
