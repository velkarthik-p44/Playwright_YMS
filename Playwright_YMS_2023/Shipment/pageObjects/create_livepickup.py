...
class CreateLivePickupPage:
    ...
    def __init__(self, page):
        ...
        self._selectloadtype = page.get_by_role("tabpanel", name="Details").get_by_text("live")
    ...
    def newlivepickup(self, livepickupdetails):
        self.click_shipment()
        self.select_pickup()
        self.create_pickup()
        self.click_pickup()
        self.enter_shipment(livepickupdetails['Shipment#'])
        self.choose_site()
        self.select_site()
        ...
        self.enter_ref1(livepickupdetails['Ref1'])
        self.enter_ref2(livepickupdetails['Ref2'])
        self.enter_trailer(livepickupdetails['Trailer'])
        self.enter_lp(livepickupdetails['LP'])
        self.next_page1()
        self.next_page2()
        self.save_pickup()
