class GateAdhocLiveArrival:

    def __init__(self, page):
        self.page = page
        self._clicklive = page.get_by_role("button", name="Live")
    ...
    def livearrival(self, formdetails):
        self.click_live()
        self.click_shipmentnum()
        self.enter_shipmentnum(formdetails['Shipment Num#'])
        self.click_trailernum()
        self.enter_trailernum(formdetails['Trailer Num#'])
        self.choose_scac()
        self.select_scac()
        self.choosetype()
        self.selecttype()
        self.click_seal1()
        self.enter_seal1(formdetails['SEAL1'])
        self.click_seal2()
        self.enter_seal2(formdetails['SEAL2'])
        self.click_cab()
        self.enter_cab(formdetails['CAB'])
        self.click_drivercell()
        self.enter_drivercell(formdetails['DRIVER CELL'])
        self.click_firstname()
        self.enter_firstname(formdetails['FIRST NAME'])
        self.click_lastname()
        self.enter_lastname(formdetails['LAST NAME'])
        self.click_emailid()
        self.enter_emailid(formdetails['EMAIL'])
        # self.click_driverlicense()
        # self.enter_driverlicense(formdetails['DRIVER LICENSE'])
        # self.click_licensestate()
        # self.enter_licensestate(formdetails['LICENSE STATE'])
        self.click_comments()
        self.enter_comments(formdetails['COMMENTS'])
        self.live_arrival()
