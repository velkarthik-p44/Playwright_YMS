...
class CreateDropDelivery:
    ...
    def newdropdelivery(self, deliverydetails):
        self.click_shipment()
        self.select_delivery()
        self.create_delivery()

        self.enter_shipment(deliverydetails['Shipment#'])
        self.choose_site()
        self.select_site()
        self.choose_vendor()
        self.select_vendor()
        ...
        self.enter_ref1(deliverydetails['Ref1'])
        self.enter_ref2(deliverydetails['Ref2'])
        self.enter_trailer(deliverydetails['Trailer'])
        self.enter_lp(deliverydetails['LP'])
        self.next_page1()
        self.next_page2()
        self.save_pickup()
