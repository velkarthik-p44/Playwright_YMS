...
class CreatePickupPage:
    ...
    def newpickup(self, details):
        self.click_shipment()
        self.select_pickup()
        self.create_pickup()
        self.click_pickup()
        self.enter_shipment(details['Shipment#'])
        self.choose_site()
        self.select_site()
        ...
        self.enter_ref1(details['Ref1'])
        self.enter_ref2(details['Ref2'])
        self.enter_trailer(details['Trailer'])
        self.enter_lp(details['LP'])
        self.next_page1()
        self.next_page2()
        self.save_pickup()
